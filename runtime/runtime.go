...
type Runtime interface {
	...
	CreateService(space string, app string, port int, labels map[string]string, features structs.Features) (c *Createspec, e error)
	UpdateService(space string, app string, port int, labels map[string]string, features structs.Features) (c *Createspec, e error)
